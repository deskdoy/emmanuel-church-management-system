...
export function AuditLogsView() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      const [nextLogs, nextUsers] = await Promise.all([loadAuditLogs(filters), loadAuditUsers()]);
  ...
  return <section className="audit-layout">
    ...
    <section className="panel table-panel audit-panel">
      ...
      <p className="audit-note">Audit records are read-only and cannot be edited or deleted from Emmanuel Cash Flow.</p>
