...
type View = "dashboard" | "transactions" | "income" | "expenses" | "payables" | "accounts" | "reports" | "analytics" | "audit";
...
export default function Home() {
  ...
  if (profile?.role === "Admin") navItems.push(["audit", "◇", "Audit Logs"]);
